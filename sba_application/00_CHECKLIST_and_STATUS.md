...
**Lender contact:** John Hart (SourceFunding) | **Loan request:** $555,000 SBA 7(a) | **Total project:** $750,000
...
- **Startup change of ownership (CHOW)** — Tyler Hospice Hold LLC acquires 100% of Hickory Hospice LLC,
  an established Medicare-certified agency (billing-ready day one). No current operating affiliate
  (VistaRiver interest sold Aug 2025; passive note only).
- **Sources:** SBA $555,000 (74%) + equity $195,000 (26%) = **$750,000**. Seller paid in full at close — **no seller note**.
- **Uses:** $300,000 seller payoff + $63,000 startup + $15,000 equipment + $372,000 working-capital reserve = $750,000.
- **Equity injection:** $195,000 cash from **James Bullard** for a **19.5%** passive minority interest
  ($100K wired 5/7/2026; $95K committed by 7/31/2026). Under 20% → no PG, no PFS, source-of-funds verification only.
  26% injection is above the 10% SOP 50 10 8 minimum but below the ~30% some startup lenders prefer — flag for lender fit.
- **Cap table:** Adeline & Lilah 39.9% / Bullard 19.5% / Shelton-Davenport-Woodard 13.3% each / reserved 0.7% = 100%.
- **Guarantor:** Geoff Schackmann (sole 20%+ owner via Adeline & Lilah, LLC; 39.9%). Mary Elizabeth Burcham
  (spouse, 19.95% indirect, passive) signs spouse consent only.
- **Coverage (SBA-only debt $93,637/yr):** DSCR Y1 3.23x / Y2 7.26x / Y3 10.76x; global 7.08x. Min cash $262,558.
...
| — | Operating Agreement v7 (as provided) | **PROVIDED** — needs Amendment No. 1 executed | `08_entity_documents/*AS_PROVIDED*` |
| — | OA Reconciliation Memo + Amendment No. 1 | **DRAFTED** | `08_entity_documents/` |
...
5. **Entity docs:** WY formation certificate + EIN confirmation letter; **execute OA Amendment No. 1** (cap table
   to 39.9/19.5/13.3×3/0.7, partnership tax, SBA carve-outs) — the as-provided OA v7 still shows the old 60/25/4.9.
...
- **Equity injection:** $195,000 cash from James Bullard for **19.5%** passive interest (no convertible note;
  Form 155 framing dropped). Phased $100K (received 5/7/2026) + $95K (by 7/31/2026). SBA loan raised to $555K
...
- **Lender fit at 26% injection.** Above SBA's 10% floor; below the ~30% John's LOC lender prefers for startups.
  Strong DSCR (3.23x Y1) offsets — confirm which lender in John's network fits, or whether more equity is wanted.
- **Borrower entity name/state** (MIPA "Texas" vs SBA/OA "Wyoming") — reconcile (B2).
- **Execute OA Amendment No. 1** so the cap table/tax/structure match the application (B3).
